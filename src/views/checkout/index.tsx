          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
            ...
            <aside className="space-y-8 lg:sticky lg:top-32 lg:h-fit">
              ...
              <Link href="/event-detail/confirmation">
                <button className="flex w-full items-center justify-center rounded-lg bg-blue-700 px-6 py-4 text-base font-bold text-white shadow-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 cursor-pointer">
                  Konfirmasi
                </button>
              </Link>
            </aside>
